...
public class ObjectClient {
  ...
  public NestedObjectWithOptionalField getAndReturnNestedWithOptionalField(
    ...
    try {
      Response _response = clientOptions.httpClient().newCall(_request).execute();
      if (_response.isSuccessful()) {
        return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), NestedObjectWithOptionalField.class);
      }
      throw new RuntimeException();
    }
    catch (Exception e) {
  ...
  public NestedObjectWithRequiredField getAndReturnNestedWithRequiredField(
    ...
    try {
      Response _response = clientOptions.httpClient().newCall(_request).execute();
      if (_response.isSuccessful()) {
        return ObjectMappers.JSON_MAPPER.readValue(_response.body().string(), NestedObjectWithRequiredField.class);
      }
      throw new RuntimeException();
    }
    catch (Exception e) {
