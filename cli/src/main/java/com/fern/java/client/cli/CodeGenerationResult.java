...
public abstract class CodeGenerationResult {
    ...
    public static String getModelBuildGradle(FernPluginConfig pluginConfig) {
        return "plugins {\n"
                ...
                + "    api project('io.github.fern-api:exception-utils:" + pluginConfig.getVersion() + "')\n"
                + "    api project('io.github.fern-api:immutables-utils:" + pluginConfig.getVersion() + "')\n"
                + "\n"
    ...
    public static String getClientBuildGradle(FernPluginConfig pluginConfig) {
        return "plugins {\n"
                ...
                + "    api project('io.github.fern-api:auth-utils:" + pluginConfig.getVersion() + "')\n"
                + "    api project('io.github.fern-api:exception-utils:" + pluginConfig.getVersion() + "')\n"
                + "    api project('io.github.fern-api:immutables-utils:" + pluginConfig.getVersion() + "')\n"
                + "    api project('io.github.fern-api:jackson-utils:" + pluginConfig.getVersion() + "')\n"
                + "    implementation 'com.fasterxml.jackson.core:jackson-databind:2.12.3'\n"
